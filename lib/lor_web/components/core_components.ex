defmodule LorWeb.CoreComponents do
  @moduledoc """
  ...
  def icon(assigns) do
    class =
      cond do
        is_list(assigns.class) ->
          [assigns.name | assigns.class]

        is_binary(assigns.class) ->
          [assigns.name, assigns.class]
      end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LorWeb.Gettext, "errors", msg, opts)
    end
  end

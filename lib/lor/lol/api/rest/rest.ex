defmodule Lor.Lol.Rest do
  ...
  @doc """
  Given a region, puuid and optionnaly a start return a list of
  ranked_solo_game match ids.
  ## Example
    iex> RiotApi.list_matches(:EUROPE, "8tjefad_ZLY2X8UbmwYlR1PBtaRgJBxcOcvFZ8tMy6f4bw56fMaIvLoqA87DK3yzqihZs7L-VQCdBw")
  ...
  def list_matches(region, puuid, start \\ 0) do
    client = Lor.Lol.RestClients.get_client(region)
  ...
  def fetch_summoner_by_name(platform_id, summoner_name) do
    client = Lor.Lol.RestClients.get_client(platform_id)
  ...
  the league data.
  """
  def fetch_league(platform_id, encrypted_summoner_id) do
    client = Lor.Lol.RestClients.get_client(platform_id)
  ...
  the active game.
  """
  def fetch_active_game_by_summoners(platform_id, encrypted_summoner_id) do
    client = Lor.Lol.RestClients.get_client(platform_id)

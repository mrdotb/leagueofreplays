...
config :lor, LorWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "U9FW33ZojupO3gZVwKZR8Bmmgf/Y/Y5tw71y7dTJ36By3EJBoy8Q13w01n32UmJS",
  watchers: [
...
config :lor, LorWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/lor_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :lor, dev_routes: true
